...
impl KRSAssembler2 {
    pub fn exec(cpu: &mut KoshkaCPU2) {
        ...
        let inst_size = match opcode {
            ...
            // div ax, imm16        10
            0x10 => {
                let arg_high = cpu.memory[cpu.pc as usize + 1];
                let arg_low = cpu.memory[cpu.pc as usize + 2];
            ...
            // div bx imm16         12
            0x12 => {
                let arg1 = cpu.memory[cpu.pc as usize + 1];
                let arg2 = cpu.memory[cpu.pc as usize + 2];
                let arg = (arg1 << 8) | arg2; 
            ...
            // div reg reg          1A
            0x1A => {
                let reg1 = cpu.memory[cpu.pc as usize + 1];
                let reg2 = cpu.memory[cpu.pc as usize + 2];
